...
<header class="article-hero">
            Implementation
            <h1>How to Give Every Employee AI: A Practical Guide for Teams of 5 to 5,000</h1>

        <img src="https://ienable.ai/blog/images/how-to-give-every-employee-ai-hero.jpg" alt="How to Give Every Employee AI: A Practical Guide for Teams of 5 to 5,000" class="hero-image" style="width:100%;max-width:1344px;height:auto;border-radius:12px;margin:1.5rem 0 2rem 0;display:block;">
            ...
            <video autoplay muted loop playsinline>
                <source src="post3-hero.mp4" type="video/mp4">
            </video>
...
#### The One-Line Pitch for Your Team
            ...
            Think about how people relate to their devices. Nobody says "I'm going to use my Apple iPhone 15 Pro Max to check my schedule." They say "let me check my phone." The naming strips away the technology layer and makes it a *relationship*.
                ...
                <video autoplay muted loop playsinline>
                    <source src="post3-support1.mp4" type="video/mp4">
                </video>
